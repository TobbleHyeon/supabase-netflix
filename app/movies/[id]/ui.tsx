...
export default function UI({ movie }): JSX.Element {
    return (
        <div className='flex flex-col md:flex-row items-center'>
            <img src={movie.image_url} className='w-1/3' alt='' />
            <div className='md:w-2/3 w-full items-center flex flex-col p-6 gap-4'>
